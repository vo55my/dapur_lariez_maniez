  ...
  return (
    <section id="hero" className="relative min-h-screen overflow-hidden">
      <div className="absolute inset-0">
        <div className="grid h-full gap-2 p-2 opacity-30 sm:grid-cols-2 md:grid-cols-4">
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-[1200px] items-center justify-start px-5 md:px-16">
        <div className="max-w-xl" data-aos="fade-up">
          <h1 className="mb-6 text-4xl font-secondary font-bold leading-tight text-[#9e3d00]">
            Catering Snack & Hidangan Rumahan untuk Acara Formal dan Non Formal
          </h1>
          <p className=" mb-10 max-w-xl text-lg leading-relaxed text-[#4f463f]" data-aos="fade-up" data-aos-delay="100">
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            <Link
              href="#order"
              className="inline-flex items-center justify-center gap-2 rounded-full bg-[#9e3d00] px-8 py-4 text-lg text-white transition hover:scale-[0.98]"
              data-aos="zoom-in"
              data-aos-delay="200"
            >
            ...
            <Link
              href="#menu"
              className="inline-flex items-center justify-center gap-2 rounded-full border-2 border-[#74554b] px-8 py-4 text-lg text-[#74554b] transition hover:bg-[#74554b]/10"
              data-aos="zoom-in"
              data-aos-delay="300"
            >
              Lihat Menu
